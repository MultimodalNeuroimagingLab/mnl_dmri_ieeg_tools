...
%   simplify plotting and reduce computation time. We also re-write the
...
color={[.2 .7 .2], [.9 0 .6], [.9 .8 .5], [.5 .8 .9], [.2 .7 .2], [.9 0 .6], [.9 .8 .5], [.5 .8 .9], [.2 .7 .2], [.9 0 .6], [.9 .8 .5], [.5 .8 .9]};
...
%Render all the DTI tracks. Color can be changed in the initialize step
